...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatDollarcoinURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + CoinUnits::formatWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatDollarcoinURI(info));
}
