...
#ifndef _DOLLARCOINRPC_CLIENT_H_
#define _DOLLARCOINRPC_CLIENT_H_ 1
...
/** Show help message for dollarcoin-cli.
 ...
 *
 * @note the argument can be removed once dollarcoin-cli functionality is removed from dollarcoind
 */
