...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("dollarcoin.sipa.be", "seed.dollarcoin.sipa.be"));
        vSeeds.push_back(CDNSSeedData("bluematt.me", "dnsseed.bluematt.me"));
        vSeeds.push_back(CDNSSeedData("dashjr.org", "dnsseed.dollarcoin.dashjr.org"));
...
public:
    CTestNetParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("dollarcoin.petertodd.org", "testnet-seed.dollarcoin.petertodd.org"));
